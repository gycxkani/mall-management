...
<template>
  <div>
          ...
          <template #default="scope">
            <div>
              ...
              <el-button
                ...
                :icon="Delete"
                size="small"
                @click="delNewsById(scope.row.id)"
              />
            </div>
          </template>
        </el-table-column>
    ...
    <!-- 新增公告 -->
    <el-dialog
      v-model="dialogVisibleAddNews"
      :title="newsTitle"
      width="40%"
      @close="closeAdd"
    >
      <el-form
        ref="ruleFormRefAddNews"
        :model="ruleFormAddNews"
        :rules="rulesAddNews"
      >
        ...
        <el-form-item label="内容" prop="content">
          <el-input
            type="textarea"
            :rows="2"
            v-model="ruleFormAddNews.content"
          />
        </el-form-item>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="addNewsOk"> 确定 </el-button>
        </span>
      </template>
    </el-dialog>
  </div>
