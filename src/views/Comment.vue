          ...
          <template #default="scope">
            <div class="setComment">
              ...
              <div>
                ...
                <p>
                  <el-avatar
                    v-for="(item, i) in scope.row.review.image"
                    :key="i"
                    shape="square"
                    :size="80"
                    :src="item"
                ...
                <p v-if="!scope.row.extra">
                  <el-button type="primary" @click="openDialig(scope.row)"
                    >回复</el-button
                  >
                </p>
                <div
                  v-else
                  class="setMain"
                  v-for="(item, i) in scope.row.extra"
                  :key="i"
                >
                  <span>回复：</span>
                  {{ item.data }}
                  <p>
                    <span
                      ...
                      @click="oppenDialogEdit(scope.row, item.data)"
                      >修改</span
                    >
                  </p>
                </div>
