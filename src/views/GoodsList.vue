  ...
  <div>
    <el-card>
      ...
      <el-row style="margin-top: 15px">
        <el-col>
          <el-button type="primary" size="small" @click="oppenAddDialog"
            >新增商品</el-button
          >
          <el-button
            type="danger"
          ...
          <el-button
            ...
            v-if="queryData.tab == 'all' || queryData.tab == 'off'"
            >上架</el-button
          >
          <el-button
            plain
            ...
            v-if="queryData.tab == 'all' || queryData.tab == 'saling'"
            >下架</el-button
          >
        </el-col>
      </el-row>
      ...
      >
        ...
        <el-table-column label="审核状态" v-if="queryData.tab !== 'delete'">
          <template #default="scope">
            ...
            <div v-else>
              <el-tag type="success" class="tag2" v-if="scope.row.ischeck == 1"
                >通过</el-tag
              >
          ...
          <template #default="scope">
            <div v-if="queryData.tab !== 'delete'" class="editClass">
              <el-button
                ...
                :icon="Edit"
                size="small"
                @click="oppenEditDialog(scope.row)"
              />
              <!-- <span class="btnClass" @click="oppenSetBanner(scope.row)" :loading="scope.row.isLoading">设置轮播图</span> -->
              <el-button
                class="btnClass"
                @click="oppenSetBanner(scope.row)"
                :loading="scope.row.isLoading"
                >设置轮播图</el-button
              >
              <el-button
                class="btnClass1"
                @click="oppenGoodsInfoDialog(scope.row)"
                :loading="scope.row.goodsInfoLoading"
                >设置商品详情</el-button
              >

              <el-button
                class="btnClass2"
                @click="oppenGoodsSku(scope.row)"
                :loading="scope.row.goodsSkuLoading"
                >设置商品规格</el-button
              >
            </div>
            <div v-else>暂无操作</div>
    ...
    >
      <el-form :model="addGoodsData" label-width="110px">
        ...
        <el-form-item label="库存预警">
          <el-input
            v-model="addGoodsData.min_stock"
            class="inputWidth"
            type="number"
          >
          </el-input>
        ...
        <el-form-item label="原价格">
          <el-input
            v-model="addGoodsData.min_oprice"
            class="inputWidth"
            type="number"
          >
        ...
        <el-form-item label="活动价格">
          <el-input
            v-model="addGoodsData.min_price"
            class="inputWidth"
            type="number"
          >
            <template #append>元</template>
